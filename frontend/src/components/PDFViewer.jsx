    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between glass px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <a href={fileUrl} download={filename || "document.pdf"} className="p-1.5 rounded-lg hover:bg-white/5 text-gray-400 hover:text-white transition-colors" title="Download PDF">
